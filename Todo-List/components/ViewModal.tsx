      ...
      >
        ...
        >
          <Text
            ...
            style={{ fontWeight: "bold", marginBottom: 12, color: "#1a1a1a" }}
          >
            {task?.title}
          </Text>
          ...
          <Text
            variant="bodyMedium"
            style={{ color: "#666", marginBottom: 6, fontWeight: "500" }}
          >
            Descripción:
          </Text>
          ...
          >
            <Text
              variant="bodyMedium"
              style={{ marginRight: 12, fontWeight: "500", color: "#666" }}
            >
              Estado:
            </Text>
            <Chip
              ...
              style={{
                backgroundColor: task?.completed ? "#d5f4e6" : "#fef5e7",
              }}
            >
